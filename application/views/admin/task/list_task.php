										...
										<?php if(isset($list)): ?>
											<?php $n = 1; foreach ($list as $row): ?>
												<tr>
													...
													<td class="text-center"><a href="<?php echo base_url(); ?>admin/edit_del_task/<?php echo $row->task_id?>/edit" class="glyphicon glyphicon-pencil"></a></td>
                                        			<td class="text-center"><a href="<?php echo base_url(); ?>admin/edit_del_task/<?php echo $row->task_id?>/delete" class="glyphicon glyphicon-remove del"></td>
												</tr>
											<?php $n++; endforeach; ?>
										<?php endif; ?>
